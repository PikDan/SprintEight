...
func (s ParcelStore) Add(p Parcel) (int, error) {
	...
	res, err := s.db.Exec("INSERT INTO parcel (client, status, address, created_at) VALUES ($1, $2, $3, $4)",
...
func (s ParcelStore) GetByClient(client int) ([]Parcel, error) {
	...
	for rows.Next() {
		parcels := Parcel{}
		err := rows.Scan(&parcels.Number, &parcels.Client, &parcels.Status, &parcels.Address, &parcels.CreatedAt)
		if err != nil {
			fmt.Println(err)
			return nil, err
		}
